...
public class EGLRender extends Thread implements SurfaceTexture.OnFrameAvailableListener {
    ...
    private void eglSetup(Surface surface) {
        ...
        EGLContext eglContext = EGL14.eglCreateContext(mEGLDisplay, configs[0], EGL14.EGL_NO_CONTEXT, attrib_list, 0);
        ...
        EGLSurface eglSurface = EGL14.eglCreatePbufferSurface(mEGLDisplay, configs[0], surfaceAttribs, 0);
        ...
        mEGLContext = EGL14.eglCreateContext(mEGLDisplay, configEncoder, eglContext, attrib_list, 0);
        checkEglError("eglCreateContext");
        if (mEGLContext == null) {
            throw new RuntimeException("null context2");
        }

        int[] surfaceAttribs2 = {EGL14.EGL_NONE};
        mEGLSurface = EGL14.eglCreateWindowSurface(mEGLDisplay, configEncoder, surface, surfaceAttribs2, 0);   //creates an EGL window surface and returns its handle
