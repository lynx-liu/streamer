...
public final class SurfaceControl {
    ...
    public static Surface getSurface(long nativeObject) {
        Constructor constructor = null;
        try {
            constructor = Surface.class.getDeclaredConstructor(long.class);
            constructor.setAccessible(true);
            return (Surface) constructor.newInstance(nativeObject);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
